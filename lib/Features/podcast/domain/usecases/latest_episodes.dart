...
class LatestEpisodesUsecase extends UseCaseWithoutParams<List<EpisodeEntity>> {
  const LatestEpisodesUsecase(this._repository);
  final PodcastRepository _repository;

  @override
  ResultFuture<List<EpisodeEntity>> call() => _repository.getLatestEpisodes();
}
